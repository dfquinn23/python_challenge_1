...
while place_order:
    ...
    if menu_category.isdigit():
        ...
        if int(menu_category) in menu_items.keys():
            ...
            menu_item_number = input("Please enter the number of the menu item you want: ") #DFQCODE

            # 3. Check if the customer typed a number
            if menu_item_number.isdigit():  #DFQCODE
             # Convert the menu selection to an integer
                menu_item_number = int(menu_item_number) #DFQCODE
                ...
                if menu_item_number in menu_items:
                    ...
                    quantity = input(f"How many of {selected_item} ['Item name'] would you like?" )
                    ...
                    print("Your selection isn't valid. Please try again. ")

                # Tell the customer they didn't select a menu option
            else:
                print("You did not select a menu item.")
...
for item in order_list:
    ...
    print(f"{item_name}{item_spaces}| ${price:.2f}{price_space}| {quantity}{quantity_space}")
